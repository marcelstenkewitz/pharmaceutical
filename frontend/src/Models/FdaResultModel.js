...
export class FDAResult {
  ...
  constructor(obj = {}) {
    this.product_ndc = obj.product_ndc;
    this.generic_name = obj.generic_name;
    this.labeler_name = obj.labeler_name;
    this.brand_name = obj.brand_name;
    this.active_ingredients = (obj.active_ingredients || []).map(a => new FDAActiveIngredient(a));
    this.finished = obj.finished;
    this.packaging = (obj.packaging || []).map(p => new FDAPackaging(p));
    this.listing_expiration_date = obj.listing_expiration_date;
    this.openfda = new FDAOpenFda(obj.openfda);
    this.marketing_category = obj.marketing_category;
    this.dosage_form = obj.dosage_form;
    this.spl_id = obj.spl_id;
    this.product_type = obj.product_type;
    this.route = obj.route || [];
    this.marketing_start_date = obj.marketing_start_date;
    this.product_id = obj.product_id;
    this.application_number = obj.application_number;
    this.brand_name_base = obj.brand_name_base;
    this.pharm_class = obj.pharm_class || [];
  }
